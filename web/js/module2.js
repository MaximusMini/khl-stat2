...
$(document).ready(function(){
    ...
    $('select').change(function(e){
        ...
        var arrTeamLength = [
            ...
            'Динамо Мн':142, 'Динамо Р':121, 'Йокерит':113, 'Куньлунь РС':149, 'Локомотив':146, 'Металлург Мг':195, 'Нефтехимик':166, 'Салават Юлаев':210, 'Северсталь':157, 'Сибирь':89, 'СКА':60, 'Слован':89, 'Спартак':115, 'Торпедо':92, 'Трактор':125, 'ХК Сочи':115, 'ЦСКА':69,}
        ];

...
PMA_messages['strFunctionHint'] = "Удерживайте Shift и кликните на имени функции для применения ко всем строкам.";
...
PMA_messages['strHoverDbFastFilter'] = "Для фильтрации по всем базам данных, нажмите Enter после ввода поискового запроса";
PMA_messages['strHoverFastFilter'] = "Для фильтрации по всем %s в базе данных, нажмите Enter после ввода поискового запроса";
PMA_messages['strTables'] = "таблицам";
PMA_messages['strViews'] = "представлениям";
PMA_messages['strProcedures'] = "процедурам";
PMA_messages['strEvents'] = "событиям";
PMA_messages['strFunctions'] = "функциям";
...
PMA_messages['strSendErrorReport'] = "Отправить отчёт об ошибке";
...
PMA_messages['phpErrorsFound'] = "<div class=\"error\">На сервере обнаружены некоторые ошибки!<div>Пожалуйста, посмотрите вниз текущего окна.<input id=\"pma_ignore_errors_popup\" type=\"submit\" value=\"Игнорировать\" style=\"float: right; margin: 20px;\"><input id=\"pma_ignore_all_errors_popup\" type=\"submit\" value=\"Игнорировать всё\" style=\"float: right; margin: 20px;\"></div></div>";
...
PMA_messages['strNoLocalStorage'] = "Ваш браузер не поддерживает настройку из локальных источников, либо превышен допустимый лимит. Некоторые функции могут работать некорректно. В браузере Safary, данная проблема возникает из-за включенного \"Private Mode Browsing\".";
